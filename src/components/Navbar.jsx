 ...
 const Navbar = ({ totalCartItems }) => {
     return ( 
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style={{zIndex:1}}>
            <Link to={url} className="navbar-brand col-sm-3 col-md-2 mr-0 ">foodie fast foods</Link>
                    ...
                    <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                        <span className="nav-item dropdown user">
                            ...
                            <div className="dropdown-content" aria-labelledby="navbarDropdownMenuLink">
                                <Link className="dropdown-item text-left" to={url+ "user"} ><i className="fa fa-user fa-lg mr-2"></i> My Profile</Link>
                                <Link className="dropdown-item text-left" to={url+ "orders"} ><i className="fa fa-shopping-bag fa-lg mr-2"></i> Orders</Link>
                                <Link className="dropdown-item text-left" to={url+ "orders"} ><i className="fa fa-power-off fa-lg mr-2"></i> Logout</Link>
                            </div>
                        </span>
