        ...
        <div className="col-md-10">
          <div className="row">
            <div className="col-md-3 text-left">
              <div
                className="card btn mb-2"
                onClick={() => this.handleClick("user_details")}
              >
                <div className="row">
                  <div className="col-md-2  m-2 d-flex align-items-center justify-content-center">
                    <img
                      src={user.imageUrl}
                      width="40"
              ...
              >
                <div className="row">
                  ...
                  <div className="col mt-2 mb-2 pl-0 pr-0">Saved Cards</div>
                </div>
              </div>
            </div>
            <div className="col-md-8">
              {(() => {
                switch (selected) {
                  case "address":
                    return <Address isdelete={true} />;
                  case "payments":
                    return <Payments isdelete={true} />;
                  case "user_details":
                    return <UserDetails />;
                  default:
                    return <UserDetails />;
